...
OrderAddress.create!(order_id: 76, address_id: 1)
OrderAddress.create!(order_id: 76, address_id: 2)
OrderAddress.create!(order_id: 77, address_id: 3)
OrderAddress.create!(order_id: 77, address_id: 4)
...
OrderProduct.create!(order_id: 76, product_id: 5)
OrderProduct.create!(order_id: 76, product_id: 1)
OrderProduct.create!(order_id: 77, product_id: 5)
OrderProduct.create!(order_id: 77, product_id: 9)